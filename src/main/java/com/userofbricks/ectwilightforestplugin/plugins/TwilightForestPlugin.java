...
public class TwilightForestPlugin  implements IExpandedCombatPlugin {
    ...
    public void registerMaterials(RegistrationHandler registrationHandler) {
        IRONWOOD =    registrationHandler.registerMaterial(new MaterialBuilder(REGISTRATE, "Ironwood", CONFIG.ironwood).gauntlet().shield()
                .weaponBuilder(VanillaECPlugin.BATTLE_STAFF, VanillaECPlugin.NETHERITE, TFWeaponItem.Dyeable::new).build()
                .weaponBuilder(VanillaECPlugin.BROAD_SWORD, VanillaECPlugin.NETHERITE, TFWeaponItem.Dyeable::new).build()
                .weaponBuilder(VanillaECPlugin.CLAYMORE, VanillaECPlugin.NETHERITE, TFWeaponItem.Dyeable::new).build()
                .weaponBuilder(VanillaECPlugin.CUTLASS, VanillaECPlugin.NETHERITE, TFWeaponItem::new).build()
                .weaponBuilder(VanillaECPlugin.DAGGER, VanillaECPlugin.NETHERITE, TFWeaponItem::new).build()
                .weaponBuilder(VanillaECPlugin.DANCERS_SWORD, VanillaECPlugin.NETHERITE, TFWeaponItem.Dyeable::new).build()
                .weaponBuilder(VanillaECPlugin.FLAIL, VanillaECPlugin.NETHERITE, TFWeaponItem::new).build()
                .weaponBuilder(VanillaECPlugin.GLAIVE, VanillaECPlugin.NETHERITE, TFWeaponItem.Dyeable::new).build()
                .weaponBuilder(VanillaECPlugin.GREAT_HAMMER, VanillaECPlugin.NETHERITE, (m, w, p) -> new TFHammerWeaponItem(m, p)).build()
                .weaponBuilder(VanillaECPlugin.KATANA, VanillaECPlugin.NETHERITE, (m, w, p) -> new TFKatanaItem(m, p)).build()
                .weaponBuilder(VanillaECPlugin.MACE, VanillaECPlugin.NETHERITE, TFWeaponItem::new).build()
                .weaponBuilder(VanillaECPlugin.SCYTHE, VanillaECPlugin.NETHERITE, TFWeaponItem.HasPotion::new).build()
                .weaponBuilder(VanillaECPlugin.SICKLE, VanillaECPlugin.NETHERITE, TFWeaponItem::new).build()
                .weaponBuilder(VanillaECPlugin.SPEAR, VanillaECPlugin.NETHERITE, TFWeaponItem::new).build()
        );
